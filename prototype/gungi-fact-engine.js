(() => {
  ...
  function build(input = {}) {
    ...
    const densityTriggered = densityFacts.filter(fact => fact.triggered);
    const supportTriggered = supportFacts.filter(fact => fact.triggered);
    ...
    return {
      ...
      stats: {
        ...
        densityCandidateCount: densityTriggered.length,
        densitySupportCandidateCount: supportTriggered.length
      }
    };
  }
